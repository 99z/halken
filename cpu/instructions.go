...
func (gbcpu *GBCPU) loadInstructions() {
	gbcpu.Instrs = map[byte]Instruction{
		...
		0x16: Instruction{"LD D,i8", 8, 2, func() int { gbcpu.INCrn(&gbcpu.Regs.d); return 0 }},
		...
		0x1E: Instruction{"LD E,i8", 8, 2, func() int { gbcpu.INCrn(&gbcpu.Regs.e); return 0 }},
		...
		0x22: Instruction{"LDI (HL),A", 8, 1, func() int { gbcpu.LDIaaR(&gbcpu.Regs.h, &gbcpu.Regs.l, &gbcpu.Regs.a); return 0 }},
		...
		0x2A: Instruction{"LDI A,(HL)", 8, 1, func() int { gbcpu.LDIRaa(&gbcpu.Regs.a, &gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0x32: Instruction{"LDD (HL),A", 8, 1, func() int { gbcpu.LDDaaR(&gbcpu.Regs.h, &gbcpu.Regs.l, &gbcpu.Regs.a); return 0 }},
		0x33: Instruction{"INC SP", 8, 1, func() int { gbcpu.INCSP(); return 0 }},
		0x34: Instruction{"INC (HL)", 12, 1, func() int { gbcpu.INCaa(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0x35: Instruction{"DEC (HL)", 12, 1, func() int { gbcpu.DECaa(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0x36: Instruction{"LD (HL),i8", 12, 2, func() int { gbcpu.LDaan(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0x37: Instruction{"SCF", 4, 1, func() int { gbcpu.SCF(); return 0 }},
		0x38: Instruction{"JR C,s8", 8, 2, func() int { return gbcpu.JRCn() }},
		0x39: Instruction{"ADD HL,SP", 8, 1, func() int { gbcpu.ADDrrSP(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0x3A: Instruction{"LDD A,(HL)", 8, 1, func() int { gbcpu.LDraa(&gbcpu.Regs.a, &gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0x86: Instruction{"ADD A,(HL)", 8, 1, func() int { gbcpu.ADDraa(&gbcpu.Regs.a, &gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0x8E: Instruction{"ADC A,(HL)", 8, 1, func() int { gbcpu.ADCraa(&gbcpu.Regs.a, &gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0x96: Instruction{"SUB (HL)", 8, 1, func() int { gbcpu.SUBaa(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0x9E: Instruction{"SBC A,(HL)", 8, 1, func() int { gbcpu.SBCraa(&gbcpu.Regs.a, &gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0xA6: Instruction{"AND (HL)", 8, 1, func() int { gbcpu.ANDaa(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0xB6: Instruction{"OR (HL)", 8, 1, func() int { gbcpu.ORaa(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		...
		0xC6: Instruction{"ADD A,i8", 8, 2, func() int { gbcpu.ADDrn(&gbcpu.Regs.a); return 0 }},
		...
		0xE2: Instruction{"LD ($FF00+C),A", 8, 1, func() int { gbcpu.LDffrr(&gbcpu.Regs.c, &gbcpu.Regs.a); return 0 }},
		...
		0xE9: Instruction{"JP (HL)", 4, 1, func() int { gbcpu.JPHL(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0xEA: Instruction{"LD (a16),A", 16, 3, func() int { gbcpu.LDnnr(&gbcpu.Regs.a); return 0 }},
		...
		0xF0: Instruction{"LD A,($FF00+a8)", 12, 2, func() int { gbcpu.LDrffn(&gbcpu.Regs.a); return 0 }},
		0xF1: Instruction{"POP AF", 12, 1, func() int { gbcpu.POPrr(&gbcpu.Regs.a, &gbcpu.Regs.f); return 0 }},
		0xF2: Instruction{"LD A,($FF00+C)", 8, 1, func() int { gbcpu.LDrffr(&gbcpu.Regs.a, &gbcpu.Regs.c); return 0 }},
		...
		0xF8: Instruction{"LD HL,SP+s8", 12, 2, func() int { gbcpu.LDrrSPs(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0xF9: Instruction{"LD SP,HL", 8, 1, func() int { gbcpu.LDSPHL(&gbcpu.Regs.h, &gbcpu.Regs.l); return 0 }},
		0xFA: Instruction{"LD A,(a16)", 16, 3, func() int { gbcpu.LDrnn(&gbcpu.Regs.a); return 0 }},
