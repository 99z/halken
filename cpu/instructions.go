...
func (gbcpu *GBCPU) loadInstructions() {
	gbcpu.Instrs = map[byte]Instruction{
		...
		0x09: Instruction{"ADD HL,BC", 8, 0, func() { gbcpu.ADDHLrr(&gbcpu.Regs.b, &gbcpu.Regs.c) }},
		...
		0x19: Instruction{"ADD HL,DE", 8, 0, func() { gbcpu.ADDHLrr(&gbcpu.Regs.d, &gbcpu.Regs.e) }},
		...
		0x29: Instruction{"ADD HL,HL", 8, 0, func() { gbcpu.ADDHLrr(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		...
		0xA0: Instruction{"AND B", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.b) }},
		0xA1: Instruction{"AND C", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.c) }},
		0xA2: Instruction{"AND D", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.d) }},
		0xA3: Instruction{"AND E", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.e) }},
		0xA4: Instruction{"AND H", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.h) }},
		0xA5: Instruction{"AND L", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.l) }},
		0xA6: Instruction{"AND (HL)", 8, 0, func() { gbcpu.ANDaa(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xA7: Instruction{"AND A", 4, 0, func() { gbcpu.ANDr(&gbcpu.Regs.a) }},
		0xA8: Instruction{"XOR B", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.b) }},
		0xA9: Instruction{"XOR C", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.c) }},
		0xAA: Instruction{"XOR D", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.d) }},
		0xAB: Instruction{"XOR E", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.e) }},
		0xAC: Instruction{"XOR H", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.h) }},
		0xAD: Instruction{"XOR L", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.l) }},
		0xAE: Instruction{"XOR (HL)", 8, 0, func() { gbcpu.XORaa(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xAF: Instruction{"XOR A", 4, 0, func() { gbcpu.XORr(&gbcpu.Regs.a) }},
		0xB0: Instruction{"OR B", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.b) }},
		0xB1: Instruction{"OR C", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.c) }},
		0xB2: Instruction{"OR D", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.d) }},
		0xB3: Instruction{"OR E", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.e) }},
		0xB4: Instruction{"OR H", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.h) }},
		0xB5: Instruction{"OR L", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.l) }},
		0xB6: Instruction{"OR (HL)", 8, 0, func() { gbcpu.ORaa(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xB7: Instruction{"OR A", 4, 0, func() { gbcpu.ORr(&gbcpu.Regs.a) }},
		0xB8: Instruction{"CP B", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.b) }},
		0xB9: Instruction{"CP C", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.c) }},
		0xBA: Instruction{"CP D", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.d) }},
		0xBB: Instruction{"CP E", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.e) }},
		0xBC: Instruction{"CP H", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.h) }},
		0xBD: Instruction{"CP L", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.l) }},
		0xBE: Instruction{"CP (HL)", 8, 0, func() { gbcpu.CPaa(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xBF: Instruction{"CP A", 4, 0, func() { gbcpu.CPr(&gbcpu.Regs.a) }},
		0xC0: Instruction{"RET NZ", 8, 0, func() { gbcpu.RETNZ() }},
		0xC1: Instruction{"POP BC", 12, 0, func() { gbcpu.POPrr(&gbcpu.Regs.b, &gbcpu.Regs.c) }},
		0xC2: Instruction{"JP NZ,a16", 16, 2, func() { gbcpu.JPNZaa() }},
		0xC3: Instruction{"JP a16", 16, 2, func() { gbcpu.JPaa() }},
		0xC4: Instruction{"CALL NZ,a16", 12, 2, func() { gbcpu.CALLNZaa() }},
		0xC5: Instruction{"PUSH BC", 16, 0, func() { gbcpu.PUSHrr(&gbcpu.Regs.b, &gbcpu.Regs.c) }},
		0xC6: Instruction{"ADD A,i8", 8, 1, func() { gbcpu.ADDrn(&gbcpu.Regs.a) }},
		0xC7: Instruction{"RST 00", 16, 0, func() { gbcpu.RST(0x00) }},
		0xC8: Instruction{"RET Z", 8, 0, func() { gbcpu.RETZ() }},
		0xC9: Instruction{"RET", 16, 0, func() { gbcpu.RET() }},
		0xCA: Instruction{"JP Z,a16", 12, 2, func() { gbcpu.JPZaa() }},
		0xCB: Instruction{"PREFIX CB", 4, 0, func() {}},
		0xCC: Instruction{"CALL Z,a16", 12, 2, func() { gbcpu.CALLZaa() }},
		0xCD: Instruction{"CALL a16", 24, 2, func() { gbcpu.CALLaa() }},
		0xCE: Instruction{"ADC A,i8", 8, 1, func() { gbcpu.ADCrn(&gbcpu.Regs.a) }},
		0xCF: Instruction{"RST 08H", 16, 0, func() { gbcpu.RST(0x08) }},
		0xD0: Instruction{"RET NC", 8, 0, func() { gbcpu.RETNC() }},
		0xD1: Instruction{"POP DE", 12, 0, func() { gbcpu.POPrr(&gbcpu.Regs.d, &gbcpu.Regs.e) }},
		0xD2: Instruction{"JP NC,a16", 12, 2, func() { gbcpu.JPNCaa() }},
		// 0xD3: no corresponding instruction
		0xD4: Instruction{"CALL NC,a16", 12, 2, func() { gbcpu.CALLNCaa() }},
		0xD5: Instruction{"PUSH DE", 16, 0, func() { gbcpu.PUSHrr(&gbcpu.Regs.d, &gbcpu.Regs.e) }},
		0xD6: Instruction{"SUB i8", 8, 1, func() { gbcpu.SUBn() }},
		0xD7: Instruction{"RST 10H", 16, 0, func() { gbcpu.RST(0x10) }},
		0xD8: Instruction{"RET C", 8, 0, func() { gbcpu.RETC() }},
		0xD9: Instruction{"RETI", 16, 0, func() { gbcpu.RETI() }},
		0xDA: Instruction{"JP C,a16", 12, 2, func() { gbcpu.JPCaa() }},
		// 0xDB: no corresponding instruction
		0xDC: Instruction{"CALL C,a16", 12, 2, func() { gbcpu.CALLCaa() }},
		// 0xDD: no corresponding instruction
		0xDE: Instruction{"SBC A,i8", 8, 1, func() { gbcpu.SBCrn(&gbcpu.Regs.a) }},
		0xDF: Instruction{"RST 18H", 16, 0, func() { gbcpu.RST(0x18) }},
		0xE0: Instruction{"LDH ($FF00+a8),A", 12, 1, func() {}},
		0xE1: Instruction{"POP HL", 12, 0, func() {}},
		0xE2: Instruction{"LD ($FF00+C),A", 8, 0, func() { gbcpu.LDffrr(&gbcpu.Regs.c, &gbcpu.Regs.a) }},
		// 0xE3: no corresponding instruction
		// 0xE4: no corresponding instruction
		0xE5: Instruction{"PUSH HL", 16, 0, func() { gbcpu.PUSHrr(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xE6: Instruction{"AND i8", 8, 1, func() { gbcpu.ANDn() }},
		0xE7: Instruction{"RST 20H", 16, 0, func() { gbcpu.RST(0x20) }},
		0xE8: Instruction{"ADD SP,s8", 16, 1, func() { gbcpu.ADDSPs() }},
		0xE9: Instruction{"JP (HL)", 4, 0, func() { gbcpu.JPrr(&gbcpu.Regs.h, &gbcpu.Regs.l) }},
		0xEA: Instruction{"LD (a16),A", 16, 2, func() { gbcpu.LDnnr(&gbcpu.Regs.a) }},
		// 0xEB: no corresponding instruction
		// 0xEC: no corresponding instruction
		// 0xED: no corresponding instruction
		0xEE: Instruction{"XOR i8", 8, 1, func() { gbcpu.XORn() }},
		0xEF: Instruction{"RST 28", 16, 0, func() { gbcpu.RST(0x28) }},
		0xF0: Instruction{"LD A,($FF00+a8)", 12, 1, func() { gbcpu.LDrffn(&gbcpu.Regs.a) }},
		0xF1: Instruction{"POP AF", 12, 0, func() { gbcpu.POPrr(&gbcpu.Regs.a, &gbcpu.Regs.f) }},
		0xF2: Instruction{"LD A,($FF00+C)", 8, 0, func() { gbcpu.LDrffr(&gbcpu.Regs.a, &gbcpu.Regs.c) }},
		0xF3: Instruction{"DI", 4, 0, func() { gbcpu.DI() }},
		// 0xF4: no corresponding instruction
		0xF5: Instruction{"PUSH AF", 16, 0, func() { gbcpu.PUSHrr(&gbcpu.Regs.a, &gbcpu.Regs.f) }},
		...
		0xFE: Instruction{"CP i8", 8, 1, func() { gbcpu.CPn() }},
		0xFF: Instruction{"RST 38H", 16, 0, func() { gbcpu.RST(0x38) }}}
}
